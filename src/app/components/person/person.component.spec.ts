...
describe('PersonComponent', () => {
  ...
  // it('should have <p> with "Soy un parrafo"' nativeElement, () => {
  ...
  // it('should have <h3> with "Hola, PersonComponent" debugElement', () => {
  ...
  // it('should have <p> with "Soy un parrafo" debugElement', () => {
  //   const personDebug: DebugElement = fixture.debugElement;
